...
<html lang="en">
    <head>
        ...
        <title> Authentification · Amis </title>
            ...
            <form method="post" action="index.php">
                ...
                <p class="err">
                    <?php
                        ...
                        if (isset($valider)) {
                            $amis->authentification($_POST['idt'], $_POST['pass']);
                        }
                ...
                <div class="form-floating">
                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="idt">
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit" name="valider">Se connecter</button>
                ...
                <label><br>
                    <p>Vous n'avez pas de compte <a href="inscription.php" class="lien-form">Inscrivez-vous</a>.</p>
                </label>
